export default [{
    ...
    occupation: 'Always spread the love when I get back',
    rating: 10,
    rank: 7,
}, {
    id: 'u8',
    ...
    occupation: 'She aint know no better but I did, poor decision making for the kid',
    rating: 5,
    rank: 8,
}, {
    id: 'u9',
    ...
    occupation: 'No fake shit against me shall propser',
    rating: 5,
    rank: 9,
}, {
    id: 'u10',
    ...
    occupation: 'Free yourselves from all forms of conditioning - JK',
    rating: 10,
    rank: 10,
}]
